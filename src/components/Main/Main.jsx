	...
	return(
		...
		<section className="main">
			<div className="main__description">
				...
				<p className="main__description-text">Sou desenvolvedor full stack com foco em criar soluções web eficientes e escaláveis. 
					...
					tanto acadêmicos quanto profissionais.Estudo Engenharia de Software na 42 Rio e já participei de formações complementares pela TripleTen 
